...
class AEPDGP_net:
    ...
    def train(self, x_test=None, y_test=None,
              ...
              reinit_hypers=True, compute_test=False, compute_logZ=False, file_time=None, file_rmse=None, file_llh=None):
        ...
        test_nll, test_rms, energy = \
            self.sepdgp_obj.train(self.x_train, self.y_train_normalised, self.y_train, 
                                  x_test, y_test,
                                  no_epochs=no_epochs,
